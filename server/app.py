...
from controllers.jobs_controller import CreateJob, AllJobs, JobById, JobsByCompany, FilterJobs, ArchivedJobs, ArchivedJobsByCompany
...
# api.add_resource(SeedJob, '/jobs/seed', endpoint='seed_jobs')
api.add_resource(ArchivedJobs, '/jobs/archived', endpoint='archived_jobs')
api.add_resource(ArchivedJobsByCompany, '/jobs/archived/company/<int:id>', endpoint='archived_jobs_by_company')
